...
Detailed results for all experiments are shown in \Table{tab:FullResults}.   Full optimization code for our method will be released open source concurrent to the conference.  See the supplemental video to view runtime results and the supplemental PDF for CPU code.
