...
In our experiments, we use traditional sparse blendshapes (where we store matrix $\matA$ using sparse format) as a baseline.  As part of our preprocessing pipeline, deltas smaller than $10 \mu m$ in absolute value are clamped to zero. 
