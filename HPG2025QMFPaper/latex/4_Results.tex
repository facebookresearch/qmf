...
As shown in \Figure{fig:Teaser} \replace{and}{,}  \Figure{fig:QMFNewNormAndWrinkles} \add{and \Figure{fig:poses}}, the sparse factorization method preserves details in challenging wrinkle areas. 
%
