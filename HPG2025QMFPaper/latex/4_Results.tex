...
Detailed results for all experiments are shown in \Table{tab:FullResults}. We have made our sparse factorization optimization code available at \url{https://github.com/facebookresearch/qmf}. See the supplemental video to view runtime results and the supplemental PDF for CPU code.
