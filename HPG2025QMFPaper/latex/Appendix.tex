...
% \raisebox{-.5\height}{\includegraphics[width=0.15\linewidth, trim=0pt -1mm 0pt -1mm]{#1NoseOrig.png}\ifthenelse{\equal{#1}{proteus}}{\llap{\includegraphics[height=0.075\linewidth]{legendDistanceMap.pdf}}}{}
% }&
...
\rotatebox[origin=c]{90}{\centering #2}
% \raisebox{-.5\height}{\includegraphics[width=\poseWidth]{#1NoseOrig.png}\llap{\includegraphics[height=0.075\linewidth]{legendDistanceMap.pdf}}}
\raisebox{-.5\height}{\includegraphics[width=\poseWidth]{#1NoseOrig.png}\llap{\ifthenelse{\equal{#1}{proteus}}{\includegraphics[height=0.090\linewidth]{legendDistanceMap.pdf}}{}}}
...
\begin{figure*}[p]
  ...
  \lineOfCaptions
    \caption{A visual inspection of error of CSFB vs QMF.  The error visualized in red is the vertex distance between uncompressed and the CSFB and QMF compressed methods.}
\label{fig:poses}
\end{figure*}
