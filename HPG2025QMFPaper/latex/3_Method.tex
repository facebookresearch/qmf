...
To find solutions for \Equation{eq:Minimization} we use the Adam optimizer. After each Adam iteration, we perform projection to the desired number of nonzeros, ensuring the sparsity of both matrices $\matB$ and $\matC$. These projections do not participate in automatic differentiation.
