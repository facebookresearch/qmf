...
\begin{teaserfigure}
    ...
    \end{minipage}
    \hspace{1.5cm}
    \caption{Comparison of blendshape compression algorithms. Dem Bones (\cite{dembones}) and \csfb(\cite{kavan2024compressed}) do not preserve wrinkles.  Our method, \qmf, preserves wrinkles well, while also providing much higher compression ratio. }
    \label{fig:Teaser}
\end{teaserfigure}
\maketitle
