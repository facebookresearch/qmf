...
%\commentfalse
\commenttrue
\newcommand{\LK}[1]{\ifcomment{\textcolor{orange}{(LK: #1)}}\else \fi}
\newcommand{\BB}[1]{\ifcomment{\textcolor{red}{(BB: #1)}}\else \fi}
\newcommand{\RF}[1]{\ifcomment{\textcolor{blue}{(RF: #1)}}\else \fi}
