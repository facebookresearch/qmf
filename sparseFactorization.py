...
# Tar with models can be downloaded  here: https://drive.google.com/file/d/1rJ4hvBd3y-7nA-h07QeKFjag64E-c9ef/view?usp=sharing
geometry.dataPath = "/home/romanfedotov/Documents/prototypes/Compressed_Skinning_for_Facial_Blendshape/in/"
...
def runModel():
    ...
    paperParams = {
        ...
        "louise": ds.TotalNnzMaxPerCCol(
            all=130_000, densityMult=0.000456, maxNumPerCCol=30
        ),
        "carlos": ds.TotalNnzMaxPerCCol(
            all=140_000, densityMult=0.000263, maxNumPerCCol=30
        ),
        #
        "jupiter-wrinklesDemo": ds.TotalNnzMaxPerCCol(
            all=35_000, densityMult=0, maxNumPerCCol=50
        ),
    }

    for model in ["aura"]:  # ["boz", "jupiter", "proteus", "louise", "carlos"]:
        ...
        for numBits in [0, 8, 11_11_10, 16]:  # , 11_11_10
